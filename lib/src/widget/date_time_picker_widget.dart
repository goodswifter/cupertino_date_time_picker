...
class _DateTimePickerWidgetState extends State<DateTimePickerWidget> {
  ...
  Widget _renderDatePickerWidget() {
    ...
    for (var format in formatArr) {
      ...
      final Widget pickerColumn = PickerColumnComponentWidget(
  ...
  List<int> _calcSelectIndexList() {
    final int yearIndex = _currYear - _minTime.year;
  ...
  List<int> _calcMonthRange() {
    ...
    final int minYear = _minTime.year;
    final int maxYear = _maxTime.year;
  ...
  List<int> _calcDayRange({currMonth}) {
    ...
    final int minYear = _minTime.year;
    final int maxYear = _maxTime.year;
    final int minMonth = _minTime.month;
    final int maxMonth = _maxTime.month;
